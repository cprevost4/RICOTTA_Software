function EZ = clustered_ricotta(tensor_Y1,tensor_Y2,tensor_Y3,D3,R,patch_nb,par,nb_cluster,bparams)
...
for k = 1:nb_cluster
         ...
         Y22 = tens2mat(tensor_Y1{k},2);
         Y22 = unique(Y22','rows'); Y22 = Y22';
         par.K=min(R(2),min(size([Y12 Y22],1), size([Y12 Y22],2)));
         V1 = Nonnegative_DL([Y12 Y22],par);
